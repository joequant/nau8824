...
static bool nau8824_writeable_reg(struct device *dev, unsigned int reg)
{
	...
	case NAU8824_REG_ADC_HPF_FILTER ... NAU8824_REG_EQ4_EQ5:
	case NAU8824_REG_ADC_CH0_DGAIN_CTRL ... NAU8824_REG_ADC_TO_DAC_ST:
	case NAU8824_REG_DRC_KNEE_IP12_ADC_CH01 ... NAU8824_REG_DRC_ATKDCY_ADC_CH23:
...
static const char *nau8824_tdm_slot[] = {
...
static const struct snd_kcontrol_new nau8824_snd_controls[] = {
	...
	SOC_SINGLE_TLV("Speaker Left Volume from DACL",
		NAU8824_REG_CLASSD_GAIN_2, 0, 0x1f, 0, spk_vol_tlv),
	SOC_SINGLE_TLV("Speaker Left Volume from DACR",
		NAU8824_REG_CLASSD_GAIN_1, 0, 0x1f, 0, spk_vol_tlv),
	SOC_SINGLE_TLV("Speaker Right Volume from DACL",
		NAU8824_REG_CLASSD_GAIN_2, 8, 0x1f, 0, spk_vol_tlv),

	SOC_SINGLE_TLV("Headphone Right Volume from DACR",
		NAU8824_REG_ATT_PORT0, 8, 0x1f, 0, hp_vol_tlv),
	SOC_SINGLE_TLV("Headphone Left Volume from DACL",
		NAU8824_REG_ATT_PORT0, 0, 0x1f, 0, hp_vol_tlv),
	SOC_SINGLE_TLV("Headphone Right Volume from DACL",
		NAU8824_REG_ATT_PORT1, 8, 0x1f, 0, hp_vol_tlv),
	SOC_SINGLE_TLV("Headphone Left Volume from DACR",
...
{
	struct nau8824 *nau8824 = snd_soc_codec_get_drvdata(w->codec);
	...
	struct snd_kcontrol *kcontrol, int event)
{
	...
	switch (event) {
	case SND_SOC_DAPM_PRE_PMU:
		regmap_update_bits(nau8824->regmap, NAU8824_REG_ANALOG_CONTROL_2,
	...
	struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_POST_PMU:
		...
		msleep(10);
		regmap_update_bits(nau8824->regmap, NAU8824_REG_CHARGE_PUMP_CONTROL,
...
static irqreturn_t nau8824_interrupt(int irq, void *data)
{
	...
	if (active_irq & NAU8824_JACK_EJECTION_DETECTED) {
		dev_info(nau8824->dev, "Jack ejected\n");
...
static int nau8824_set_fmt(struct snd_soc_dai *dai, unsigned int fmt)
{
	...
	regmap_update_bits(nau8824->regmap, NAU8824_REG_PORT0_I2S_PCM_CTRL_1,
		...
		NAU8824_I2S_BP_MASK | NAU8824_I2S_PCMB_EN, ctrl1_val);
...
static int nau8824_set_clkdiv(struct snd_soc_dai *dai, int div_id, int div)
{
	struct snd_soc_codec *codec = dai->codec;
	struct nau8824 *nau8824 = snd_soc_codec_get_drvdata(codec);

	switch (div_id) {
	case NAU8824_DAC_SRC:
		regmap_update_bits(nau8824->regmap, NAU8824_REG_CLK_DIVIDER,
			NAU8824_CLK_DAC_SRC_MASK,
			(div << NAU8824_CLK_DAC_SRC_SFT));
		break;

	case NAU8824_ADC_SRC:
		regmap_update_bits(nau8824->regmap, NAU8824_REG_CLK_DIVIDER,
			NAU8824_CLK_ADC_SRC_MASK,
			(div << NAU8824_CLK_ADC_SRC_SFT));
		break;

	case NAU8824_DMIC_SRC:
		regmap_update_bits(nau8824->regmap, NAU8824_REG_CLK_DIVIDER,
			NAU8824_CLK_DMIC_SRC_MASK,
			(div << NAU8824_CLK_DMIC_SRC_SFT));
		break;
	...
	struct nau8824_fll *fll_param)
{
	...
	regmap_update_bits(regmap, NAU8824_REG_FLL4,
		NAU8824_FLL_REF_DIV_MASK, fll_param->clk_ref_div);
...
static void nau8824_init_interrupt(struct nau8824 *nau8824)
{
	struct regmap *regmap = nau8824->regmap;
	...
	regmap_update_bits(regmap, NAU8824_REG_INTERRUPT_SETTING_1,
		...
		NAU8824_IRQ_EJECT_EN | NAU8824_IRQ_INSERT_EN);
	regmap_write(regmap, NAU8824_REG_INTERRUPT_SETTING, 0x13fc);

	regmap_update_bits(regmap, NAU8824_REG_JACK_DET_CTRL,
		NAU8824_JACK_EJECT_DEBOUNCE_MASK, (nau8824->jack_eject_debounce
		<< NAU8824_JACK_EJECT_DEBOUNCE_SFT));
}
...
static void nau8824_init_regs(struct nau8824 *nau8824)
{
	...
	regmap_update_bits(regmap, NAU8824_REG_FEPGA_II,
		NAU8824_FEPGA_GAINL_MASK, 0xa);
	regmap_update_bits(regmap, NAU8824_REG_FEPGA_II,
		NAU8824_FEPGA_GAINR_MASK, (0xa << NAU8824_FEPGA_GAINR_SFT));
	...
	struct snd_soc_jack *jack)
{
	...
	nau8824->jack = jack;
	nau8824_init_interrupt(nau8824);
...
static int nau8824_read_device_properties(struct device *dev,
	...
	of_property_read_u32(dev->of_node, "nuvoton,micbias-voltage",
		&nau8824->micbias_voltage);
	of_property_read_u32(dev->of_node, "nuvoton,vref-impedance",
		&nau8824->vref_impedance);
	of_property_read_u32(dev->of_node, "nuvoton,sar-threshold-num",
		&nau8824->sar_threshold_num);
	of_property_read_u32_array(dev->of_node, "nuvoton,sar-threshold",
		nau8824->sar_threshold, nau8824->sar_threshold_num);
	of_property_read_u32(dev->of_node, "nuvoton,sar-hysteresis",
		&nau8824->sar_hysteresis);
	of_property_read_u32(dev->of_node, "nuvoton,sar-voltage",
		&nau8824->sar_voltage);
	of_property_read_u32(dev->of_node, "nuvoton,sar-compare-time",
		&nau8824->sar_compare_time);
	of_property_read_u32(dev->of_node, "nuvoton,sar-sampling-time",
		&nau8824->sar_sampling_time);
	of_property_read_u32(dev->of_node, "nuvoton,short-key-debounce",
		&nau8824->key_debounce);
	of_property_read_u32(dev->of_node, "nuvoton,jack-eject-debounce",
		&nau8824->jack_eject_debounce);
...
MODULE_DESCRIPTION("ASoC NAU8824 driver");
